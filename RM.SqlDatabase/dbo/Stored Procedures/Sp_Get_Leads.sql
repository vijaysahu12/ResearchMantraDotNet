...
BEGIN	
	...
	SELECT 
		...
		Leads.[ModifiedBy], 
		'' as [AssignedTo], isnull(Leads.StatusId , 22) as [StatusId] , isnull(st.Name , 'New') as StatusName
		...
		isnull(po.PaidAmount, 0.0) as PaidAmount , 	isnull(po.NetAmount, 0.0) as  NetAmount,ISNULL(po.TransactionRecipt ,'')AS TransactionRecipt, ISNULL(po.TransasctionReference,'')  AS TransasctionReference
