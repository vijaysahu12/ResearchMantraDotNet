...
{
    public class CustomerServiceExpiryUpdateJob : IJob
    {
        private readonly IServiceProvider _serviceProvider;
        private IConfiguration _Configuration { get; }

        public CustomerServiceExpiryUpdateJob(IServiceProvider serviceProvider, IConfiguration configuration)
        {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            await schedulerService.UpdateExpiredService();
